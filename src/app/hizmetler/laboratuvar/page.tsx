...
export default function LaboratuvarPage() {
  const structuredData = {
    ...
    "@type": "Service",
    "name": "Laboratuvar Analiz Hizmetleri",
    "provider": {
      "@type": "Organization",
      "name": "Anadolu Zemin",
    ...
    "description": "Akredite laboratuvarımızda kapsamlı zemin ve malzeme testleri. Fiziksel, mekanik ve kimyasal analizler ile detaylı sonuçlar.",
    "serviceType": ["Zemin Testleri", "Malzeme Testleri", "Fiziksel Analizler", "Mekanik Analizler", "Kimyasal Analizler"],
    "hasOfferCatalog": {
      "@type": "OfferCatalog",
      "name": "Laboratuvar Analiz Hizmetleri",
      "itemListElement": [
        {
          ...
          "itemOffered": {
            "@type": "Service",
            "name": "Fiziksel Analizler",
            "description": "Zeminin fiziksel özelliklerinin detaylı analizi"
          }
        },
        {
          "@type": "Offer",
          "itemOffered": {
            ...
            "description": "Zeminin dayanım özelliklerinin tespiti"
          }
        },
        {
          "@type": "Offer",
          "itemOffered": {
            "@type": "Service",
            "name": "Kimyasal Analizler",
            "description": "Zeminin kimyasal kompozisyonunun analizi"
          }
        }
      ]
    }
  ...
  return (
    <>
      <Script
        id="laboratuvar-structured-data"
